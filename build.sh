...
rm -frv gosnmp_traps_python/py2/*.pyc
rm -frv gosnmp_traps_python/py2/*.so
rm -frv gosnmp_traps_python/py2/*.c
rm -frv gosnmp_traps_python/cffi/*.pyc
rm -frv gosnmp_traps_python/cffi/*.so
rm -frv gosnmp_traps_python/cffi/*.c
rm -frv gosnmp_traps_python/cffi/gosnmp_traps_python.py
echo ""
...
if [[ "$1" != "fast" ]]; then
    ...
    go get -v -a github.com/ftpsolutions/gosnmp
    echo ""

    echo "building gosnmp"
    # go build -a -x github.com/soniah/gosnmp
    go build -a -x github.com/ftpsolutions/gosnmp
    echo ""
    ...
    go build -x -a gosnmp_traps_python
    echo ""
fi

echo "build gosnmp_traps_python bindings for py2"
./gopy bind -lang="py2" -output="gosnmp_traps_python/py2" -symbols=true -work=false gosnmp_traps_python
echo ""
...
./gopy bind -lang="cffi" -output="gosnmp_traps_python/cffi" -symbols=true -work=false gosnmp_traps_python
echo ""
